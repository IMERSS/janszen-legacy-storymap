...
fluid.defaults("maxwell.scrollyLeafletMap", {
    ...
    zoomDuration: 100,
    listeners: {
        "onCreate.getTiles": "maxwell.applyFirstTiles({scrollyPage}.leafletWidgets, {that}.map)"
    }
});

maxwell.applyFirstTiles = function (leafletWidgets, map) {
    ...
    if (tiles) {
        ...
        const pTiles = maxwell.findCall(firstX.calls, "addProviderTiles");

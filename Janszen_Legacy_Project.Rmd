...
Harvey Janszen (July 11, 1946–May 10, 2021) was an accomplished amateur botanist and naturalist endeared to many in British Columbia's natural history community. During his career as a botanist, Harvey collected ~3,000 vascular plant specimens from coastal BC (mostly within the southern Gulf Islands) and also curated comprehensive species checklists documenting the flora of the southern Gulf Islands, Saanich Peninsula, and San Juan Islands, as well as various other localities throughout the Salish Sea. 
...
Among the documents that Harvey left us with in his passing are journals documenting his collection activities throughout the region, from 1973 to 2017. Many of these important historical baseline records have not been digitized and so remain unavailable to the scientific community. Through the Janszen Legacy Project, we are actively digitizing these records, including herbarium specimens, list records, and field notes. Just before Harvey passed away, he had reached out to botanists in the broader community to invite their review of the comprehensive species lists he dedicated his life to compiling for the region. Today, we are honouring his request by seeing through this work. In the following maps, we provide a summary of the progress of this initiative to date.
...
Through this legacy project, we are working toward:

* The digitization and deposition of a subset of Harvey's vascular plant specimens (those that are not already deposited in research collections) in research collections at UBC

* Digitization of field notes related to the dataset

* Review and digitization of specimens already accessioned at the Royal BC Museum

* The advancement of a curatorial process focused on the comprehensive species lists that Harvey has compiled, involving a community of botanists in British Columbia and Washington

* The advancement of a biodiversity informatics working group focused on developing an online platform for hosting these data

* Curation of this important floristics dataset to DarwinCore standards for publication in an open access data depository
